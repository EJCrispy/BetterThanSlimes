...
namespace BetterThanSlimes.Content.Projectiles.Weapons
{
    ...
    public class SpookyShaftProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.usesLocalNPCImmunity = true; // Use local NPC immunity
            Projectile.localNPCHitCooldown = -1; // No cooldown for hitting NPCs
        }
